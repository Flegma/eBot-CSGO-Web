...
(function() {
    ...
    function addPlayerRow(steamid64, name) {
        ...
        tr.innerHTML =
            '<td><input type="text" name="players[' + playerIndex + '][steamid64]" value="' + (steamid64 || '') + '" placeholder="76561198000000000" /></td>' +
            '<td><input type="text" name="players[' + playerIndex + '][name]" value="' + (name || '') + '" placeholder="Player Name" /></td>' +
